...
export const createSSOTicket = withServerActionAuth(
  ...
  try {
    ...
    console.log(orgs[0])
     ...
     const ticket =  await managementClient.selfServiceProfiles.createSsoTicket({id: 'ssp_gWrU3zgBbN559eW2xqtE35'}, {enabled_clients: ['S63jfvFTGSocru0txEVtJ2PfCXie9QCW', 'vv4F6p99xSTjxSQHtCuI5qD3Q6Det6Zv' ], enabled_organizations: [{organization_id:orgs[0].id}] , connection_config: {name: orgs[0].name}, })
